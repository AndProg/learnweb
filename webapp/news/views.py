...
def single_news(news_id):
    ...
    # Чтобы привязать комментарий к новости, мы будем использовать hidden-поле news_id. 
    # Чтобы запомнить его, просто передадим его значение при создании формы во views.py
...
# если пользователь не будучи авторизованным пошлет данные на /news/comment,
# то его перенаправит на страницу авторизации
@login_required
def add_comment():
    form = CommentForm()
